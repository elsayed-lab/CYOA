    ...
    my $menus = {
        ...
        Assembly => {
            ...
            choices => {
                ...
                '(filterdepth): Filter contigs based on sequencing depth.' => \&Bio::Adventure::Assembly::Unicycler_Filter,
                '(kraken2): Taxonomically classify reads.' => \&Bio::Adventure::Annotation::Kraken,
...
sub Get_TODOs {
    ...
    my $possible_todos = {
        ...
        "filterdepth+" => \$todo_list->{todo}{'Bio::Adventure::Assembly::Unicycler_Filter'},
